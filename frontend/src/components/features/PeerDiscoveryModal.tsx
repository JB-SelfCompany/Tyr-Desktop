...
export function PeerDiscoveryModal({ isOpen, onClose, onPeersAdded }: PeerDiscoveryModalProps) {
  ...
  return (
    <Modal
      ...
      size="xl"
    >
      <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
        {/* Filters */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 bg-white/5 border border-white/20 rounded-lg text-white focus:border-neon-cyan focus:outline-none dark:[&>option]:bg-gray-800 dark:[&>option]:text-white [&>option]:bg-white [&>option]:text-gray-900"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-white/5 border border-white/20 rounded-lg text-white focus:border-neon-cyan focus:outline-none"
                />
                <p className="text-xs text-white/60 mt-1">{t('peers.discovery.maxRTTHelper')}</p>
              </div>
            </div>
                      ...
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {peer.region && (
                              <span className="text-xs text-white/60">📍 {peer.region}</span>
                            )}
                          </div>
                        ...
                        <div className="flex items-center gap-4">
                          <div className="text-right">
                            <p className="text-xs text-white/50">{t('peers.discovery.rtt')}</p>
                            <p className={`text-sm font-bold ${
                              peer.rtt < 100 ? 'text-neon-green' :
